...
namespace Ean13Barcode2005
{
	public class Ean13
	{
		...
		private float _fMaximumAllowableScale = 3.0f;

		// This is the nomimal size recommended by the EAN.
        public float _fWidth = 47f;  //37.29f
        public float _fHeight = 16f; //25.93f
        public float _fFontSize = 10f;
        public float _fScale = 0.8f;
